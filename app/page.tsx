...
import { faBrain, faHandsHelping, faLeaf } from '@fortawesome/free-solid-svg-icons';
    ...
    <div className="bg-gray-100 text-gray-900">
      ...
      <section className="bg-soft-ivory py-12">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-center mb-8">What My Readers Say</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white shadow-lg rounded-lg p-6">
              <p className="text-gray-700 mb-4">"Isaiah's insights into Generative AI and Ubuntu are truly transformative!"</p>
              <p className="text-yellow-600 font-bold">Thandie Ndlovu</p>
            </div>
            <div className="bg-white shadow-lg rounded-lg p-6">
              <p className="text-gray-700 mb-4">"A must-read for anyone interested in the future of technology."</p>
              <p className="text-yellow-600 font-bold">David Thompson</p>
            </div>
            <div className="bg-white shadow-lg rounded-lg p-6">
              <p className="text-gray-700 mb-4">"Combining AI with Ubuntu is a visionary approach to sustainable tech."</p>
      ...
      <section className="bg-yellow-600 text-white py-12">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl mb-8">Join our newsletter to stay informed about the latest insights and developments.</p>
          {submitted ? (
            <p className="text-green-200 text-center">Thank you for subscribing! You'll hear from us soon.</p>
          ) : (
